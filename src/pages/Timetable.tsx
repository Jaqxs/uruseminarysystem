...
export default function Timetable() {
  ...
  const schedule: Record<string, Record<string, { subject: string; teacher: string }>> = {
    "7:30 - 8:30": { [t('Monday')]: { subject: t('mathAca'), teacher: `${t('teacherAbbr')} Kamau` }, [t('Tuesday')]: { subject: t('englishAca'), teacher: `${t('teacherAbbr')} Gabriel` }, [t('Wednesday')]: { subject: t('biologyAca'), teacher: `${t('teacherAbbr')} David` }, [t('Thursday')]: { subject: t('historyAca'), teacher: `${t('teacherAbbr')} Francis` }, [t('Friday')]: { subject: t('ict'), teacher: `${t('teacherAbbr')} Amos` } },
    "8:30 - 9:30": { [t('Monday')]: { subject: t('kiswahiliAca'), teacher: `${t('teacherAbbr')} Stephen` }, [t('Tuesday')]: { subject: t('mathAca'), teacher: `${t('teacherAbbr')} Kamau` }, [t('Wednesday')]: { subject: t('englishAca'), teacher: `${t('teacherAbbr')} Gabriel` }, [t('Thursday')]: { subject: t('geographyAca'), teacher: `${t('teacherAbbr')} Baraka` }, [t('Friday')]: { subject: t('biologyAca'), teacher: `${t('teacherAbbr')} David` } },
    "9:30 - 10:30": { [t('Monday')]: { subject: t('biologyAca'), teacher: `${t('teacherAbbr')} David` }, [t('Tuesday')]: { subject: t('historyAca'), teacher: `${t('teacherAbbr')} Francis` }, [t('Wednesday')]: { subject: t('mathAca'), teacher: `${t('teacherAbbr')} Kamau` }, [t('Thursday')]: { subject: t('ict'), teacher: `${t('teacherAbbr')} Amos` }, [t('Friday')]: { subject: t('kiswahiliAca'), teacher: `${t('teacherAbbr')} Stephen` } },
    ...
    "11:30 - 12:30": { [t('Monday')]: { subject: t('ict'), teacher: `${t('teacherAbbr')} Amos` }, [t('Tuesday')]: { subject: t('physicsAca'), teacher: `${t('teacherAbbr')} Peter` }, [t('Wednesday')]: { subject: t('geographyAca'), teacher: `${t('teacherAbbr')} Baraka` }, [t('Thursday')]: { subject: t('mathAca'), teacher: `${t('teacherAbbr')} Kamau` }, [t('Friday')]: { subject: t('historyAca'), teacher: `${t('teacherAbbr')} Francis` } },
    ...
    "14:00 - 15:00": { [t('Monday')]: { subject: t('physicsAca'), teacher: `${t('teacherAbbr')} Peter` }, [t('Tuesday')]: { subject: t('kiswahiliAca'), teacher: `${t('teacherAbbr')} Stephen` }, [t('Wednesday')]: { subject: t('ict'), teacher: `${t('teacherAbbr')} Amos` }, [t('Thursday')]: { subject: t('biologyAca'), teacher: `${t('teacherAbbr')} David` }, [t('Friday')]: { subject: t('geographyAca'), teacher: `${t('teacherAbbr')} Baraka` } },
    "15:00 - 16:00": { [t('Monday')]: { subject: t('historyAca'), teacher: `${t('teacherAbbr')} Francis` }, [t('Tuesday')]: { subject: t('geographyAca'), teacher: `${t('teacherAbbr')} Baraka` }, [t('Wednesday')]: { subject: t('physicsAca'), teacher: `${t('teacherAbbr')} Peter` }, [t('Thursday')]: { subject: t('englishAca'), teacher: `${t('teacherAbbr')} Gabriel` }, [t('Friday')]: { subject: t('mathAca'), teacher: `${t('teacherAbbr')} Kamau` } },
  };
